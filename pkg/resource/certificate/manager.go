...
// +kubebuilder:rbac:groups=acmpca.services.k8s.aws,resources=certificates,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=acmpca.services.k8s.aws,resources=certificates/status,verbs=get;update;patch
