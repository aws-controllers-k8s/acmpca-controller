...
import (
	...
	svcsdkapi "github.com/aws/aws-sdk-go/service/acmpca/acmpcaiface"
...
// +kubebuilder:rbac:groups=acmpca.services.k8s.aws,resources=certificateauthorityactivations,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=acmpca.services.k8s.aws,resources=certificateauthorityactivations/status,verbs=get;update;patch
