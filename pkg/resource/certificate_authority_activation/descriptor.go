...
const (
	FinalizerString = "finalizers.acmpca.services.k8s.aws/CertificateAuthorityActivation"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("certificateauthorityactivations")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CertificateAuthorityActivation{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CertificateAuthorityActivation),
	}
}
