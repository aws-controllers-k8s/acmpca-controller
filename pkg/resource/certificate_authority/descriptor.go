...
const (
	FinalizerString = "finalizers.acmpca.services.k8s.aws/CertificateAuthority"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("certificateauthorities")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CertificateAuthority{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CertificateAuthority),
	}
}
