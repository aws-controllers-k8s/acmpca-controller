...
// +kubebuilder:rbac:groups=acmpca.services.k8s.aws,resources=certificateauthorities,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=acmpca.services.k8s.aws,resources=certificateauthorities/status,verbs=get;update;patch
